...
function createAdminClient() {
    const url = ("TURBOPACK compile-time value", "https://gninseyojtjnfonoerve.supabase.co");
...
"[project]/app/api/mqtt/ingest/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    try {
        ...
        if (signature && secret) {
            try {
                ...
                if (__TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["default"].timingSafeEqual(Buffer.from(expected), Buffer.from(signature))) {
                    verified = true;
                }
            } catch (e) {
        ...
        // If not HMAC-verified, try to authenticate the request via Supabase session
        if (!verified) {
            try {
        ...
        if (deviceError || !device) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Device not found for topic"
            }, {
                status: 404
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e5853bc3._.js.map